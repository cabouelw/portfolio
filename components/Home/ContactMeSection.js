...
function Contact() {
    ...
    return (
        <div className="text-gray flex flex-col gap-4 justify-center items-center ">
            ...
            <span className='border-2 border-solid border-primary py-2 px-4 w-fit text-[#fff] font-sans cursor-pointer hover:bg-primary md:hidden hover:scale-110 transition duration-700 ease-in-out' ><a a href="ChoaibAbouelwafa.pdf" target="_blank" rel="noopener noreferrer" download>My Resume {">"}</a></span></div>
        </div>
    );
}
